...
msiexec.exe /i splunkforwarder-9.1.1-64e843ea36b1-x86-release.msi AGREETOLICENSE=yes SPLUNKUSERNAME=$username SPLUNKPASSWORD=$password RECEIVING_INDEXER=$reciever DEPLOYMENT_SERVER=$management WINEVENTLOG_APP_ENABLE=1 WINEVENTLOG_SEC_ENABLE=1 WINEVENTLOG_SYS_ENABLE=1 ENABLEADMON=1 /quiet